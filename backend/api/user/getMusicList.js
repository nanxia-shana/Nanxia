...
router.get("/", (req, res) => {
  try {
    console.log("user.03.01_getMusicList - headers: ", req.headers);
    console.log("user.03.01_getMusicList - queries: ", req.query);
    console.log("user.03.01_getMusicList - bodys: ", req.body);
